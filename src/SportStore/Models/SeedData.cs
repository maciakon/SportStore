    ...
    public static class SeedData
    {
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            context.Products.AddRange(
                ...
                new Product { Name = "Corner flags", Description = "Give your playing field a professional touch", Category="Soccer", Price = 19.50m},
                new Product { Name = "Stadium", Description = "Flat-packed, 35.000 seats stadium", Category="Soccer", Price = 79500},
                new Product { Name = "Thinking cap", Description = "Improve brain efficiency by 75%", Category="Chess", Price = 16},
                new Product { Name = "Unsteady chair", Description = "Secretly gives your opponnen a disadvantage", Category="Chess", Price = 29.95m},
